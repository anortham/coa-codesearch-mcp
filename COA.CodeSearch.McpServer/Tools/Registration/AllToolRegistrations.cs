        ...
        registry.RegisterTool<RecallContextParams>(
            ...
            inputSchema: new
            {
                ...
                properties = new
                {
                    ...
                    scopeFilter = new { type = "string", @enum = new[] { "ArchitecturalDecision", "CodePattern", "SecurityRule", "ProjectInsight", "WorkSession", "LocalInsight" }, description = "Filter by type: ArchitecturalDecision, CodePattern, SecurityRule, ProjectInsight, WorkSession, LocalInsight" },
