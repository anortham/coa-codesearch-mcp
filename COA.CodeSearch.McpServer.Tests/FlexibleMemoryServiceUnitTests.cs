...
public class FlexibleMemoryServiceUnitTests : IDisposable
{
    ...
    public FlexibleMemoryServiceUnitTests()
    {
        ...
        _memoryService = new FlexibleMemoryService(_memoryLoggerMock.Object, _configuration, _indexService, _pathResolutionMock.Object, errorHandlingMock.Object, validationMock.Object, facetingServiceMock.Object, scoringServiceMock.Object, Mock.Of<IMemoryEventPublisher>());
    }
